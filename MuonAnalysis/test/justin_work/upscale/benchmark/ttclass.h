...
// Wed Jul 22 11:31:00 2020 by ROOT version 6.22/00
// from TTree Events/Events
// found on file: /home/t3-ku/mlazarov/softMVA/CMSSW_10_6_11_patch1/src/KUSoftMVA/MuonAnalysis/data/Test_ttjets.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ULong64_t       event;
   UInt_t          nGenPart;
   Float_t         GenPart_eta[365];   //[nGenPart]
   Float_t         GenPart_mass[365];   //[nGenPart]
   Float_t         GenPart_phi[365];   //[nGenPart]
   Float_t         GenPart_pt[365];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[365];   //[nGenPart]
   Int_t           GenPart_pdgId[365];   //[nGenPart]
   Int_t           GenPart_status[365];   //[nGenPart]
   Int_t           GenPart_statusFlags[365];   //[nGenPart]
   UInt_t          nJet;
   ...
   UInt_t          nMuon;
   Float_t         Muon_LepGood_jetDF[20];   //[nMuon]
   Float_t         Muon_LepGood_jetPtRatio[20];   //[nMuon]
   Float_t         Muon_LepGood_jetPtRelv2[20];   //[nMuon]
   Float_t         Muon_LepGood_miniRelIsoNeutral[20];   //[nMuon]
   Float_t         Muon_chi2LocalMomentum[20];   //[nMuon]
   Float_t         Muon_chi2LocalPosition[20];   //[nMuon]
   ...
   Float_t         Muon_glbKink[20];   //[nMuon]
   Float_t         Muon_glbTrackProbability[20];   //[nMuon]
   Float_t         Muon_innerTrackNormalizedChi2[20];   //[nMuon]
   Float_t         Muon_innerTrackValidFraction[20];   //[nMuon]
   ...
   Float_t         Muon_outerTrackNormalizedChi2[20];   //[nMuon]
   ...
   Float_t         Muon_segmentCompatibility[20];   //[nMuon]
   Float_t         Muon_sip3d[20];   //[nMuon]
   Float_t         Muon_softMva[20];   //[nMuon]
   Float_t         Muon_timeAtIpInOutErr[20];   //[nMuon]
   Float_t         Muon_tkRelIso[20];   //[nMuon]
   Float_t         Muon_trkKink[20];   //[nMuon]
   Float_t         Muon_trkRelChi2[20];   //[nMuon]
   Float_t         Muon_tunepRelPt[20];   //[nMuon]
   Float_t         Muon_mvaLowPt[20];   //[nMuon]
   Float_t         Muon_mvaTTH[20];   //[nMuon]
   Int_t           Muon_LepGood_jetNDauChargedMVASel[20];   //[nMuon]
   Int_t           Muon_charge[20];   //[nMuon]
   Int_t           Muon_innerTrackCharge[20];   //[nMuon]
   Int_t           Muon_jetIdx[20];   //[nMuon]
   Int_t           Muon_nPixelLayers[20];   //[nMuon]
   Int_t           Muon_nStations[20];   //[nMuon]
   Int_t           Muon_nTrackerLayersWithMeasurement[20];   //[nMuon]
   Int_t           Muon_outerTrackCharge[20];   //[nMuon]
   Int_t           Muon_pdgId[20];   //[nMuon]
   Int_t           Muon_tightCharge[20];   //[nMuon]
   Bool_t          Muon_globalTrackNonNull[20];   //[nMuon]
   UChar_t         Muon_highPtId[20];   //[nMuon]
   Bool_t          Muon_inTimeMuon[20];   //[nMuon]
   Bool_t          Muon_innerTrackNonNull[20];   //[nMuon]
   Bool_t          Muon_isGlobal[20];   //[nMuon]
   Bool_t          Muon_isGood[20];   //[nMuon]
   Bool_t          Muon_isHighPurity[20];   //[nMuon]
   ...
   Bool_t          Muon_outerTrackNonNull[20];   //[nMuon]
...
#ifdef ttclass_cxx
ttclass::ttclass(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/mlazarov/softMVA/CMSSW_10_6_11_patch1/src/KUSoftMVA/MuonAnalysis/data/Test_ttjets.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/mlazarov/softMVA/CMSSW_10_6_11_patch1/src/KUSoftMVA/MuonAnalysis/data/Test_ttjets.root");
      }
...
Int_t ttclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ttclass::LoadTree(Long64_t entry)
{
...
void ttclass::Show(Long64_t entry)
{
...
Int_t ttclass::Cut(Long64_t entry)
{
