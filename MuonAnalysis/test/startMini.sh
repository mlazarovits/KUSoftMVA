...
#new mini skimmer
cmsRun miniNtuple_cfg.py print inputFiles_load=./dasquery/bottomup/DYJetsToLL2018/sublist_1.list outputFile=./OutputFiles/DYJetsToLL2018_MINI.root maxEvents=200

cmsRun miniNtuple_cfg.py print inputFiles_load=./dasquery/bottomup/TTJets2018/sublist_1.list outputFile=./OutputFiles/TTJets2018_MINI.root maxEvents=200

cmsRun miniNtuple_cfg.py print inputFiles_load=./dasquery/bottomup/QCD_pt_600to800_2018/sublist_1.list outputFile=./OutputFiles/QCD_pt_600to800_2018_MINI.root maxEvents=200
