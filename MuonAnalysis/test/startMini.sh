...
#new mini skimmer
cmsRun miniNtuple_cfg.py print inputFiles_load=./dasquery/bottomup/DYJetsToLL2018/sublist_1.list outputFile=./OutputFiles/DYJetsToLL2018_MINI.root maxEvents=100
