...
cmsRun miniNtuple_cfg.py print inputFiles_load=./dasquery/bottomup/QCD_MuEnriched/list_1.list outputFile=../data/QCD_MuEnriched_pt_30to100_MINI.root maxEvents=1000000
